...
The main struct you'll be dealing with here is [`DianaHandler`](https://docs.rs/diana/0.2.3/diana/struct.DianaHandler.html), and the API documentation for Diana is your friend here.
